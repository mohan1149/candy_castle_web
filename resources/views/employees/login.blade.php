...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('sas') }}/css/style.css">
            ...
            <div class="full_width_login_container">
                <div class="login_form">
                    ...
                    <form action="/" method="post">
                        {!! Form::open(['url' => "/", 'method' => 'POST', 'id' => 'employee_login' ]) !!}
                        ...
                        {!! Form::password('password', ['class'=>'w3-input w3-border','required']) !!}
                        
                        {{-- submit --}}
                        {!! Form::submit(__('t.login'), ['class'=>'w3-button w3-center w3-margin-top w3-pink']) !!}
                        {!! Form::close() !!}
                        <a class="w3-right w3-margin-top" href="/forgot/password">{{ __('forgot_password') }}</a>
                    </form>
                </div>
            </div>
        </section>
