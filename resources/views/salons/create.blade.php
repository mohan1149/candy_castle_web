...
@section('content')
    <div class="w3-container">
        {!! Form::open(['url' => "salons", 'method' => 'POST', 'id' => 'salon_add_form','files'=>true ]) !!}
            <div class="w3-row">
                <div class="w3-col l3">
                    <img id="image_view" src="{{ asset('cc') }}/images/svg/default_salon.svg" width="200px" style="padding: 25px">
                ...
                <div class="w3-col l9">
                    ...
                    {!! Form::text('opening', null, ['class'=>'w3-input w3-border opening','required']) !!}
                    {{-- closing --}}
                    {!! Form::label('closing', __('t.closing_time')) !!}
                    {!! Form::text('closing', null, ['class'=>'w3-input w3-border closing','required']) !!}
                </div>
